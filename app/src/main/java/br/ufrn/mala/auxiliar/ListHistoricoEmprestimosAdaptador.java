...
public class ListHistoricoEmprestimosAdaptador extends BaseExpandableListAdapter {

    private List<String> lstGrupos;
    private HashMap<String, List<EmprestimoDTO>> lstItensGrupos;
    private Context context;

    public ListHistoricoEmprestimosAdaptador(Context context, List<String> grupos, HashMap<String, List<EmprestimoDTO>> itensGrupos) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.list_history_loan_group, null);
        }
